...
import { PlBtnGhost, PlBtnPrimary, PlDialogModal, PlRadioGroup, PlTextField } from '@platforma-sdk/ui-vue';
...
const props = defineProps<{
  onSubmit: (props: { type: 'byClonotype' | 'bySampleAndClonotype'; name: string }) => void;
}>();
